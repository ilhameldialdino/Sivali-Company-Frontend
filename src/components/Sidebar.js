        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              {/* <NavItem title="Job Post" link={Routes.JobPost.path} icon={faBriefcase} />
              <NavItem title="List Attendance" link={Routes.ListAttendance.path} icon={faCheckCircle} />
              <NavItem title="Recent Transaction" link={Routes.RecentTransaction.path} icon={faMoneyBill} />
